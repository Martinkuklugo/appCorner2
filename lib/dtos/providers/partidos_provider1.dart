...
class PartidosProvider1 extends ChangeNotifier {
  bool isLoading = true;
  ...
  List<PartidosResponseDto>? get partidos =>
      _partidos; // obtener datos del usuario

  Future fetchUsers() async {
    final response = await http
        .get(Uri.parse('http://api.ligasabatinadefutbol.com.mx/api/matches?page=95'));
